...
class _FrontWidgetState extends State<FrontWidget> {
  ...
  void initState() {
    ...
    _model.textFieldTextController ??=
        TextEditingController(text: '      Hello BUP Diary');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFFAFDBB4),
        body: SafeArea(
          top: true,
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  '        Your Artificial bro from BUP\n                whose treat u \njust like your brother from another \n                        mother.. \n                      (๑>؂•̀๑)🤍ྀི',
